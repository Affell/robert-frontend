...
export function Pricing({ onStartChat }: PricingProps) {
  return (
      ...
      <div className="container">
        ...
        >
          ...
          <p className="pricing-description">
            Comme à l'école, plus vous montez en niveau, plus vous débloquez de fonctionnalités ! 
            Nos tarifs sont aussi transparents qu'un contrôle surprise.
          </p>
        </motion.div>
        ...
        >
          {pricingTiers.map((tier, index) => (
            <motion.div
              key={tier.id}
              className={`pricing-card ${tier.popular ? 'popular' : ''} ${tier.premium ? 'premium' : ''}`}
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <motion.button
                className={`cta-button ${tier.popular ? 'popular' : ''} ${tier.premium ? 'premium' : ''}`}
                style={{ 
        ...
        >
          <div className="guarantees-grid">
            ...
            <div className="guarantee-item">
              ...
              <p>Pas de piège, pas de contrainte, comme un bon devoir maison</p>
            </div>
            <div className="guarantee-item">
              <div className="guarantee-icon">
                <Crown size={24} />
              ...
              <p>Notre équipe répond plus vite qu'un prof qui rend les copies</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <p>Rejoignez plus de 50 000 utilisateurs qui ont déjà adopté Robert AI</p>
          <motion.button
