  ...
  const allFeatures = [
    {
      ...
      description:
        "Interface de chat moderne avec réponses instantanées et contextualisation avancée.",
      features: [
    ...
    },
    {
      ...
      description:
        "Modèles de langage de pointe pour des conversations naturelles et pertinentes.",
      features: [
    ...
    <div className="features-page">
      ...
      <main className="features-container">
        ...
        >
          ...
          <p>
            Découvrez toutes les capacités de votre assistant IA intelligent
          </p>
        </motion.div>{" "}
